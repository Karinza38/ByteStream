...
public:
    ...
    ByteStream(unsigned char* buffer, unsigned int size);
    ByteStream(unsigned char* buffer, unsigned int size, const unsigned int cap);
...
template<typename T>
ByteStream &ByteStream::operator<<(const T val)
{
